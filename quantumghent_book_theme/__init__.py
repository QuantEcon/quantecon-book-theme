...
__version__ = "0.0.1"
"""quantumghent-book-theme version"""
...
def add_to_context(app, pagename, templatename, context, doctree):
    ...
    if os.path.isdir(app.outdir + "/_notebooks"):
        context["notebook_path"] = app.outdir + "/_notebooks/" + context["pagename"] + ".ipynb"
...
def setup(app):
    ...
    app.add_html_theme("quantumghent_book_theme", get_html_theme_path())
