...
def test_rtl_config_option():
    ...
    assert (
        "script_right_to_left = False" in theme_conf_content
...
def test_rtl_html_template():
    ...
    assert (
        '{% if theme_script_right_to_left %} dir="rtl"{% endif %}' in layout_content
...
def test_rtl_python_integration():
    ...
    assert (
        '"theme_script_right_to_left"' in init_content
