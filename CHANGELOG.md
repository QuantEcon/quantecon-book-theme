...
- **Dark mode documentation** (#365) — new "Dark Mode" section in `configure.md` covering palette, syntax highlighting, admonitions, image handling, and CSS customization
